...
from .views import RegisterView, LogoutAPIView,SendingEmail, PasswordforgetView,GetUpdateProfile,PasswordChange, VerifyEmail, LoginAPIView,DeleteUserViews
...
urlpatterns = [
     ...
     path('delete/' ,DeleteUserViews.as_view(), name = 'delete'),
